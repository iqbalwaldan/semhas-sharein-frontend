...
export default function TimeStart({ startTime, startMinute, setStartData }) {
  ...
  const handleEditClick = () => {
    ...
    // Call the provided functions to save the data
    startTime = time;
    startMinute = minute;

    // Optionally, you can also use setStartData if needed
    setStartData({ time, minute });
  };
